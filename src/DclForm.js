...
try {
const response = await fetch(`https://viacep.com.br/ws/${cep}/json/`);if (!response.ok) throw new Error("Erro na resposta da API");
...
yPosition -= 15;
page.drawText(`Cidade: ${cidadeRemetente}  UF: ${ufRemetente}`, {
  x: 60,
  y: yPosition,
  size: fontSize,
  font: fontRegular,
...
yPosition -= 15;
page.drawText(`Bairro: ${bairroRemetente}  CEP: ${cepRemetente}`, {
  x: 60,
  y: yPosition,
  size: fontSize,
  font: fontRegular,
